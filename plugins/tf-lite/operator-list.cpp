...
CASE(ADD, Add)
CASE(ADD_N, Unknown)
CASE(ARG_MAX, Unknown)
CASE(ARG_MIN, Unknown)
...
CASE(RESIZE_BILINEAR, Unknown)
CASE(RESIZE_NEAREST_NEIGHBOR, Unknown)
